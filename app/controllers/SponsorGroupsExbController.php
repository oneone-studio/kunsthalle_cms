...
class SponsorGroupsExbController extends BaseController {
	...
	*/
	...
	public function deleteSponsorGroup() {
		if(Input::has('id')) {
			...
			Sponsor::where('sponsor_group_id', Input::get('id'))->delete();
	...
	public function save() {
		...
		return Redirect::action('ExhibitionPagesController@edit', ['id' => Input::get('id'), 'action' => 'sponsor']);
	}
