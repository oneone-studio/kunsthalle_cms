...
class PageContentsExbController extends BaseController {
	...
	public function store() {
		...
		if(Input::has('id')) {
			...
			$content->anchor_title_de = Input::has('anchor_title_de') ? Input::get('anchor_title_de') : '';
			$content->anchor_title_en = Input::has('anchor_title_en') ? Input::get('anchor_title_en') : '';
