...
class H2textController extends BaseController {

	public function index()
	{
	}
	public function store($red_action = null)
	{	
		$f = fopen('logs/test.log', 'w+');
		fwrite($f, 'H2textController -> store() - ['.date('Y-m-d H:i:s').']');
	...
	public function save($red_action = null) {
		// echo '<pre>'; print_r(Input::all());exit;
