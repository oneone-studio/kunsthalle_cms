...
@section('content')
    ...
    <div class="page_content">
      <h3>Sponsor Group</h3>
      <p>
		{{ Form::model($sponsor_group, array('route' => 'sponsor_group.store', 'method' => 'post', 'class' => 'form-inline', 'files' => true)) }}
					...
					<div class="form-groupz" style="width:100%; height:120px; clear:both;"> 
					    ...
					    <div style="width:10%; float:left; display:inline;">
					      <?php $display = 'display:none;';
					        $hasImage = false;
					        if($sponsor_group->logo) { $display = 'display:inline;'; $hasImage = true; }
					      ?>
