				...
				<div id="downloads_block" class="form-group edit-section" style="margin-top:2px; {{$display}}">
				  <form id="dl_protection_form" method="post" action="/save-page-dl-protection" enctype="multipart/form-data" onsubmit="return checkDownloadsForm()">
		            ...
		            class="icon-fixed-width icon-trash" style="color:#fff;float:left;position:relative;left:6px;text-decoration:none;margin-top:10px;"></a></div>
