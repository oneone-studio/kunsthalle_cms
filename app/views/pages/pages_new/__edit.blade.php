		...
		<div style="list-style:none;">
			...
			@if($sections) 
			  ...
			  @foreach($sections as $pc)
			    ...
			    @if($pc->type == 'gallery' || $pc->type == 'slider')
				  ...
				  <div id="page_content_blk_{{$pc->id}}">
					...
					<p style="font-size:11px;font-family:arial; color:#333;">[Image Gallery]</p>
				  	...
				  	<div id="page_content_links_{{$pc->id}}" style="width:8%; float:left;">
		                ...
		                <a href="javascript:deleteImageSlider({{$pc->id}})" title="Delete" type="button" class="icon-fixed-width icon-trash" style="margin-left:5px;"><span class="glyphicon glyphicon-trash"></span></a>
				  	</div>
				  </div>
