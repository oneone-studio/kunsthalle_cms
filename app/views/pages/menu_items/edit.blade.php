...
@section('content')
    ...
    <div class="page_content">
      <h3>Menu Item</h3>
      <p>
		{{ Form::model($menu_item, array('route' => array('menu_items.update', $menu_item->id))) }}
...
<!-- 		<div class="form-group nl">
			    ...
			    < ?php echo Form::number('sort_order', null); ?>
			</div>
 -->
			...
			<div class="form-group">
			    <label for="exampleInputEmail1"></label>
			     ...
			     {{ Form::button('Cancel', array('id' => 'cancel_content_btn', 'onclick' => 'javascript:document.location.href="/content/menu-items";', 'class' => 'button-error pure-button button-small', 'style' => 'height:30px; margin-top:0px; padding:3px 15px 5px 15px')) }}
			</div>            
