	<div id="page_content_block" class="form-group edit-section" style="position:relative; top:20px; display:none;">
	    ...
	    <?php echo Form::text('anchor_title_de', null, ['id' => 'pc_anchor_title_de', 'style' => 'width:300px;float:left;', 'placeholder' => 'Anchor DE']); ?>
	    <?php echo Form::text('anchor_title_en', null, ['id' => 'pc_anchor_title_en', 'style' => 'width:300px;float:left;position:relative;left:15px;', 'placeholder' => 'Anchor EN']); ?>
	    <div style="clear:both;height:15px;"></div>
