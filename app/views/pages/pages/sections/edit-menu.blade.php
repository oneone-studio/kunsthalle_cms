<div id="cp_block" class="form-group" style="margin-top:20px;">
	...
	<div style="width:100%; position:relative; top:25px; margin-bottom: 15px; clear:both;">
		    ...
		    <div style="width:16px; text-align: center; display:inline; padding:0px 4px;float:left; color:#888;">|</div>
		    <a href="javascript:toggleInput('image_grid')" class="form-link"><img src="/images/new_image.png" style="width:22px;height:22px;float:left;margin-right:3px;">
		    ...
		    <div style="width:16px; text-align: center; display:inline; padding:0px 4px; float:left; color:#888;">|</div>
		    <a href="javascript:toggleInput('youtube')" class="form-link"><img src="/images/youtube.png" style="width:30px;height:30px;float:left;margin-top:-5px;margin-right:3px;"> </a>
		    <div style="width:16px; text-align: center; display:inline; padding:0px 4px; float:left; color:#888;">|</div>
		    <a href="javascript:toggleInput('audio')" class="form-link"><img src="/images/audio1.png" style="width:22px;height:22px;float:left;margin-top:0px;margin-right:3px;"> </a>
		    <div style="width:16px; text-align: center; display:inline; padding:0px 4px; float:left; color:#888;">|</div>
		    <a href="https://kunsthalle-bremen.de/page/{{$cs_id}}/{{$page->id}}" target="_blank" class="form-link">View </a>
    </div>
</div>
