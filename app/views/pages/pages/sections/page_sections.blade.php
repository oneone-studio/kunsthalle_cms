			...
			@if($sections) 
			  ...
			  @foreach($sections as $ps)
					...
					<div style="width:100%;font-size:11px;font-family:arial; color:#333;float:left;"><div style="width:40%;float:left;">[Youtube]</div>
					  <div id="youtube_links_blk_{{$ps->id}}" style="width:60%;float:left;">
					    ...
					    @endif
			                ...
			                <a href="/page-sections/del-page-section/{{$menu_item_id}}/{{$cs_id}}/{{$page->id}}/{{$ps->ps_id}}/{{$ps->id}}/youtube" title="Delete" type="button" class="icon-fixed-width icon-trash" style="margin-left:5px;"><span class="glyphicon glyphicon-trash"></span></a>
				  	   </div>
				  	</div>   
					<div style="clear:both;height:15px;"></div>
					...
					<div style="width:100%;font-size:11px;font-family:arial; color:#333;float:left;"><div style="width:40%;float:left;">[Audio]</div>
					  <div id="audio_links_blk_{{$ps->id}}" style="width:60%;float:left;">
					    ...
					    @endif
			                ...
			                <a href="/page-sections/del-page-section/{{$menu_item_id}}/{{$cs_id}}/{{$page->id}}/{{$ps->ps_id}}/{{$ps->id}}/audio" title="Delete" type="button" class="icon-fixed-width icon-trash" style="margin-left:5px;"><span class="glyphicon glyphicon-trash"></span></a>
				  	   </div>
				  	</div>   
					<div style="clear:both;height:15px;"></div>
			    ...
			    @if($ps != null && ($ps->type == 'image_grid'))
				  ...
				  <div id="image_grid_blk_{{$ps->id}}">
				  	<div id="image_grid_{{$ps->id}}" style="width:100%; font-family:georgia; font-size:14px; font-weight:normal; float:left; margin-bottom:10px; border:1px solid #e1e1e1; padding:5px;">
					<div style="width:100%;font-size:11px;font-family:arial; color:#333;float:left;"><div style="width:40%;float:left;">[Image Grid]</div>
					  <div id="image_grid_links_blk_{{$ps->id}}" style="width:60%;float:left;">
					  	<div id="image_grid_links_{{$ps->id}}" style="width:100%; display:inline; float:right; text-align:right;">
					  	@if($sec_count > 1)
					  		<a href="/page-sections/move-up/{{$menu_item_id}}/{{$cs_id}}/{{$page->id}}/{{$ps->ps_id}}" title="Edit" type="button" style="margin-left:5px;"><img src="/images/up_arrow.png" style="max-width:15px;"></a>
					    @endif
					  	@if($sec_count < count($sections))
