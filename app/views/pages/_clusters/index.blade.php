    ...
    <div class="page_content" style="position:relative">
      ...
      @foreach($clusters as $c)
          ...
          //    ?>
              ...
              <a href="/content/clusters/delete/{{ $c->id }}" title="Delete" type="button" class="icon-fixed-width icon-trash" style="margin-left:5px;"><span class="glyphicon glyphicon-trash"></span></a>
          </td>
      	</p>
