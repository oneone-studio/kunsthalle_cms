...
@section('content')
    ...
    <div class="page_content" style="position:relative">
      <h3>Clusters <a href="/content/clusters/create" class="link">new</a></h3>
      ...
      @foreach($clusters as $c)
          ...
          //    ?>
      		...
      		<td style="width:90px;"><a href="/content/clusters/edit/{{ $c->id }}" title="Edit" type="button" class="icon-fixed-width icon-pencil" style="margin-left:5px;"><span class="glyphicon glyphicon-edit"></span></a>
              <a href="javascript:deleteItem('{{$c->title_de}}', '/content/clusters/delete/{{ $c->id }}')" title="Delete" type="button" class="icon-fixed-width icon-trash" style="margin-left:5px;"><span class="glyphicon glyphicon-trash"></span></a>
          </td>
      	</p>
