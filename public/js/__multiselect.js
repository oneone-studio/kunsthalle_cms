angular.module('ui.multiselect', [])
      ...
      return {
        ...
        link: function (originalScope, element, attrs, modelCtrl) {
          ...
          function parseModel() {
            ...
            console.log('LEN: '+ scope.selIds.length);
            for(var j in scope.selIds) {
              ns += j + ' : ' + scope.selIds[j] + "\n";
            }
            console.log('-- See!!! --->>> '+ ns);
  ...
  .directive('multiselectPopup', ['$document', function ($document) {
    return {
      ...
      scope: false,
      replace: true,
      templateUrl: '/multiselect-tmpl', //'multiselect.tmpl.html'
